...
export type DIDDocumentWithMetadataExternal = Pick<DIDResolutionResult, 'didDocument' | 'didDocumentMetadata'>
...
export interface IVerificationKeys {
    ...
    readonly didUrl: `did:swtr:${IVerificationKeys['methodSpecificId']}` extends string ? string : never
